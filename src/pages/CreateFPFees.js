  ...
  render() {
      return (
         <div className="cfund-main">
            ...
            <h6>Entry Fee</h6>
            <p>
               Entry Fee is the fee you will charge your investor when they invest in your fund.<br/>
               This fee is a % of amount invested
            </p>
            <p>
                <InputText className='input100' value={this.state.value1} onChange={(e) => this.setState({ value2: e.target.value })} />
                <Slider value={this.state.value1} onChange={(e) => this.setState({ value1: e.value })} />
            </p>
            <h6>Exit Fee</h6>
            <p>
              Exit Fee is the fee you will charge your investor when they sell your fund.<br/>
               This fee is a % of amount invested
            </p>
            <p>
            ...
            <h6>Rebalance Fee</h6>
            <p>
               Rebalance Fee is the fee you will charge your investor when you rebalance your.<br/>
               fund. This fee is a % total value of fund accured every time the postfolio is <br/>
               rebalanced. The accures fees can be claimed periodically.
            </p>
            <p>
                <InputText className='input100' value={this.state.value3} onChange={(e) => this.setState({ value3: e.target.value })} />
                <Slider value={this.state.value3} onChange={(e) => this.setState({ value3: e.value })} />
            </p>
            ...
            <h6>Mining Fee</h6>
            <p>
               This fee charge to the investor when new Fund tokens are issued<br/>
            ...
            <ToggleButton checked={this.state.checked1} onChange={(e) => this.setState({checked1: e.value})} onIcon="pi pi-check" offIcon="pi pi-times" />
              ...
              <Button
                ...
                className='btncont p-col-5 p-mt-21 p-ml-1' id='btncont'
              />
            </div>
         </div>
      );
